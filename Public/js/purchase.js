...
function LoadElementEdit(btn) {
    ...
    $.post(
        ...
        {
            var output = JSON.parse(data);
            $('#ITEM_ID').val(output.ITEM_ID);
            $('#ENTER_QTE').val(output.QTE);
            $('#SALE_PRICE').val(output.LAST_PRICE);
            $('#LAST_PRICE').val(output.LAST_PRICE);
...
function TestInsuranceStatus(btn) {
    var obj ={
        ajax_action : 'purchase.TestInsuranceStatus',
        ITEM_ID : $(btn).attr('element_id')
    };
...
function ComfirmEdit() {
    ...
    var obj ={
        ...
        INVO_ID : $("#INVOIC_ID").val(),
        ITEM_ID : $("#ITEM_ID").val(),
        QTE : $("#ENTER_QTE").val(),
        BASIC_PRICE : $("#SALE_PRICE").val(),
        STATUS : $("#STATUS").val(),
        VALUE : $("#MOD").val(),
        COMPANY_ID : $("#COMPANY_ID").val(),
    };
