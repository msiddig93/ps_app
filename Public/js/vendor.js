$(function(){
      ...
      $('#add-element').click(function(e) {
          ...
          LoadElementImg(0);
          $('#action').val("vendor.add");
          $('#modal-add-element .title-top').html('<span class="content-title"> <i class="fa fa-users"></i> الموردين <i class="fa fa-chevron-left"></i> <h3>إضافة مورد جديد</h3> </span>');
...
function EditElement(btn , e)
{
    ...
    $('#modal-add-element .title-top').html('<span class="content-title"> <i class="fa fa-users"></i> الموردين <i class="fa fa-chevron-left"></i> <h3>تعديل بيانات المورد</h3> </span>');
	$('#add').modal('show',2000);
}

function LoadElementEdit(btn) {
    var obj ={
        ajax_action : 'vendor.LoadElementEdit',
    ...
    $.post(
        ...
        function(data)
        {
            ...
            $('#vend_name').val(vendor.vend_name);
            $('#address').val(vendor.address);
            $('#email').val(vendor.email);
            $('#phone').val(vendor.phone);
            $('#idElementID').val(vendor.id);
            $('#action').val("vendor.edit");
            LoadElementImg(vendor.id);
        },
        'html'
