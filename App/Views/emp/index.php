...
<section class="content-header">
    <span class="content-title"> <i class="fa fa-users"></i> الموظفين <i class="fa fa-chevron-left"></i> <h3>الرئيسية</h3> </span>
    ...
    <div class="modal-dialog" style="width: 480px !important;">
        <div class="modal-content">
            <div class="modal-body">
                <section class="content-header">
                    <span class="content-title"> <i class="fa fa-users"></i> الموظفين <i class="fa fa-chevron-left"></i> <h3>هل أنت متاكد من حذف بيانات الموظف ؟</h3> </span>
                </section>
