...
<section class="content-header">
    <span class="content-title"> <i class="fa fa-building-o"></i> شركات التامين <i class="fa fa-chevron-left"></i> <h3>الرئيسية</h3> </span>
    <ul class="header-btns">
        ...
        <li>
            <a href="<?= App::$path ?>print/NewCompany" target="_blank" class="btn btn-default">
                <i class="fa fa-print"></i>
                <span class="hidden-xs hidden-sm"> طباعة طلب</span>
            </a>
        </li>
    </ul>   
</section>
                        ...
                        <div class="row" >
                            <div class="col-xs-12" >
                                <?= $form->input("NAME","إسم الشركة",[
                                    ...
                                    "data-validation" => "length",
                                    "data-validation-length" => "1-255",
                                    "data-validation-error-msg" => "عزراً ... لايمكن ترك إسم الشركة فارغ !"
                                ]) ?>
                                ...
                                <?= $form->input("TOP_AMOUNT","السقف الاعلي للديون ",[
                                    "type" => "text",
                                    "id" => "TOP_AMOUNT",
                                    "class" => "form-control",
