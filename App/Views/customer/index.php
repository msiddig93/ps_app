<section class="content-header">
    <span class="content-title"> <i class="fa fa-users"></i> العملاء <i class="fa fa-chevron-left"></i> <h3>الرئيسية</h3> </span>
    <ul class="header-btns">
        ...
        <li>
            <a href="<?= App::$path ?>customer/printlist" target="_blank" class="btn btn-default">
                    ...
                    <form name="form-emp-search" id="form-element-search">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?= $form->input("cust_name1","الاسم الكامل",[
                                    "type" => "text",
                                    "id" => "cust_name1",
                                    "class" => "form-control",
    ...
    <div class="modal-dialog" style="width: 480px !important;">
        <div class="modal-content">
            <div class="modal-body">
                <section class="content-header">
                    <span class="content-title"> <i class="fa fa-users"></i> العملاء <i class="fa fa-chevron-left"></i> <h3>هل أنت متاكد من حذف بيانات الموظف ؟</h3> </span>
                </section>
                        ...
                        <div class="row form-add-top">
                            <div id="GetDataEdit">
                                <div class="col-sm-7 col-xs-12" >
                                    ...
                                    <?= $form->input("cust_name","الاسم الكامل",[
                                        "type" => "text",
                                        "id" => "cust_name",
                                        "class" => "form-control",
                                        "placeholder" => "الاسم الكامل",
