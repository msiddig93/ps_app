...
<section class="content-header">
    <span class="content-title"> <i class="fa fa-medkit"></i> الادوية <i class="fa fa-chevron-left"></i> <h3>الرئيسية</h3> </span>
    ...
    <div class="modal-dialog" style="width: 480px !important;">
        <div class="modal-content">
            <div class="modal-body">
                <section class="content-header">
                    <span class="content-title"> <i class="fa fa-medkit"></i> الادوية <i class="fa fa-chevron-left"></i> <h3>هل أنت متاكد من حذف بيانات الدواء ؟</h3> </span>
                </section>
            ...
            <div class="modal-body row" id="modal-add-element">
                ...
                <section class="">
                    <form method="post" enctype="multipart/form-data" id="form-save-element">
                        ...
                        <div class="row" >
                            <div class="col-xs-12" >
                                <?= $form->input("SIEANCE_NAME","الاسم العلمي",[
                                    "type" => "text",
                                    "id" => "NAME",
                                    "class" => "form-control",
                                    ...
                                    "data-validation" => "length",
                                    "data-validation-length" => "1-255",
                                    "data-validation-error-msg" => "عزراً ... لايمكن ترك الاسم العلمي فارغ !"
                                ]) ?>

                                <?= $form->input("COMMERCAL_NAME","الاسم التجاري ",[
                                    "type" => "text",
                                    "id" => "COMMERCAL_NAME",
                                    "class" => "form-control",
                                    ...
                                    "data-validation" => "length",
                                    "data-validation-length" => "1-255",
                                    "data-validation-error-msg" => "عزراً ... لايمكن ترك الاسم التجاري فارغ !"
                                ]) ?>

                                <?= $form->input("ORDER_POINT","حد المخزون",[
                                    "type" => "text",
                                    "id" => "ORDER_POINT",
                                    "class" => "form-control",
                                ...
                                <?= $form->select("UNIT","الوحدة",$unit,[
                                    "type" => "text",
                                    "id" => "UNIT",
                                    "class" => "form-control",
                                    "placeholder" => "السقف الاعلي للديون",
                                    "data-validation" => "length",
                                    "data-validation-length" => "1-255",
                                    "data-validation-error-msg" => "عزراً ... لايمكن ترك السقف الاعلي للديون فارغ !"
                                ],true) ?>

                                <?= $form->textarea("DESCR","الوصف",[
                                    "type" => "text",
                                    "id" => "DESCR",
                                    "class" => "form-control",
                                    "placeholder" => "الوصف",
                                    "data-validation" => "length",
                                    "data-validation-length" => "1-255",
                                    "data-validation-error-msg" => "عزراً ... لايمكن ترك الوصف فارغ !"
                                ]) ?>
