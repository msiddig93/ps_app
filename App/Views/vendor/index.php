<section class="content-header">
    <span class="content-title"> <i class="fa fa-users"></i> الموردين <i class="fa fa-chevron-left"></i> <h3>الرئيسية</h3> </span>
    <ul class="header-btns">
        ...
        <li>
            <a href="<?= App::$path ?>vendor/printlist" target="_blank" class="btn btn-default">
    ...
    <div class="modal-dialog" style="width: 480px !important;">
        <div class="modal-content">
            <div class="modal-body">
                <section class="content-header">
                    <span class="content-title"> <i class="fa fa-users"></i> الموردين <i class="fa fa-chevron-left"></i> <h3>هل أنت متاكد من حذف بيانات الموظف ؟</h3> </span>
                </section>
